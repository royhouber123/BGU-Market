        ...
        {tab === 0 && (
          loading ? (
                ...
                <Card sx={{ display: "flex", gap: 2, p: 2 }}>
                  ...
                  <Box sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
                    <CardContent sx={{ flex: 1, p: 0 }}>
                      <Typography component={RouterLink} to={`/product/${item.productId}`} variant="subtitle1" fontWeight={600} sx={{ textDecoration: "none", color: "text.primary", '&:hover': { textDecoration: "underline" } }}>{item.title}</Typography>
            ...
            <Box sx={{ textAlign: "center", py: 8 }}>
              ...
              <Button component={RouterLink} to={createPageUrl("Dashboard")} variant="contained" sx={{ mt: 2 }}>Browse Products</Button>
            </Box>
          )
        )}
